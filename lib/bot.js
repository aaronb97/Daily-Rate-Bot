...
class Bot {
    ...
    static checkMessage(message) {
        ...
        if (arr.length >= 2 && arr.length <= 10 && messageText && arr[0] == "/rate") {
            ...
            else
            {
                ...
                Bot.pointEnter(message.user_id, 1);
            }
        }
                    ...
                    sheets.spreadsheets.values.get({
                        ...
                        for (w = y; w > 4; w--)
                        {
                            ...
                            for (z = 1; z < x; z++)
                            {
                                ...
                                if ((rows[w][z] == undefined || rows[w][z] == "") && (rows[0][z] != 17700160 || w > 34)  )
                                {
            ...
            googleAuth.authorize()
                .then((auth) => {
                    ...
                    sheets.spreadsheets.values.get({
                        ...
                        var x;
                        x = parseInt(rows[1][2]);
                        //for (x = 2; rows[x][1] != undefined || rows[x][1] != ""; x++)
                        var z;
                        var w;
            ...
            .then((auth) => {
                ...
                sheets.spreadsheets.values.get({
                    ...
                    else
                    {
                        ...
                        Bot.sendMessage("You have drawn a " + rows[y][0] + ". You have " + rows[2][x] + " points");
                    }
        ...
        else if (arr[0] == "/cards")
        {
            ...
            .then((auth) => {
                ...
                sheets.spreadsheets.values.get({
                    ...
                    var x, y;
                    for (x = 0; rows[0][x] != message.user_id && rows[0][x] != undefined; x++);
                    var returnmessage = "You have the following cards:\n";
                    for (y = 3; y < 58; y++)
                    {
        ...
        googleAuth.authorize()
            .then((auth) => {
                ...
                sheets.spreadsheets.values.get({
                    ...
                    Bot.sendMessage("Added " + points + " point for a total of " + parseInt(rows[2][x]));
                    sheets.spreadsheets.values.update({
                        auth: auth,
                        spreadsheetId: SPREADSHEET_ID,
                        range: CARD_RANGE,
