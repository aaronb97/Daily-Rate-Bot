            ...
            .then((auth) => {
                ...
                sheets.spreadsheets.values.get({
                    ...
                    if (parseInt(rows[4][x]) + 3 < y && arr[0] == "/rate")
                    {
                        ...
                        {
                            if (missingcount > 1)
                                extra += "\nThere are " + missingcount + " non-recent missing rates, do /missing if you want";
                            else if (missingcount == 1)
                                extra += "\nThere is " + missingcount + " non-recent missing rate, do /missing if you want";
                            
                            extra += "\nYou can also do /fillabstain to fill all missing rates with abstain";
                        }
