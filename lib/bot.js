...
class Bot {
    ...
    static checkMessage(message) {
        ...
        else if (arr[0] == "/powerball")
        {
            var numbers1 = [];
            var numbers2 = [];
            var p1 = Math.floor(Math.random() * 26 + 1);
            var p2 = Math.floor(Math.random() * 26 + 1);
            var pSame = false;
            var points = 0;
            if (p1 == p2)
                pSame = true;
            ...
            console.log(numbers1[0] + " " + numbers1[1] + " " + numbers1[2] + " " + numbers1[3] + " " + numbers1[4] + " " + p1);
            
            console.log(numbers2[0] + " " + numbers2[1] + " " + numbers2[2] + " " + numbers2[3] + " " + numbers2[4] + " " + p2);
            console.log(same);
            if (same == 5 && pSame)
                points = 420000000;
            else if (same == 5)
            ...
            .then((auth) => {
                ...
                sheets.spreadsheets.values.get({
                    ...
                    if (arr[0] == "/rate" && (rows[y - 1][x] == undefined || rows[y - 1][x] == "" || rows[y - 2][x] == undefined || rows[y - 2][x] == "" || rows[y - 3][x] == undefined || rows[y - 3][x] == ""))
                        extra += "You have some missing rates in the past few days, do /missing and /ratedate\n # mm/dd/yy";
