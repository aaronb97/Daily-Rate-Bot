...
class Bot {
    ...
    static checkMessage(message) {
                ...
                .then((auth) => {
                    ...
                    sheets.spreadsheets.values.get({
                        ...
                        if (err) {
                            ...
                            Bot.sendMessage("Sheets API error (get)");
                            return;
                        }
        ...
        else if (arr.length == 1 && arr[0] == "/speak")
        {
            ...
            var woofs = ["idk whatever sound a log makes"];
                    ...
                    sheets.spreadsheets.values.get({
                        ...
                        sheets.spreadsheets.values.update({
                            ...
                            if (err) {
                                ...
                                Bot.sendMessage("Error with sheets API (update)");
                            }
                        });
                ...
                .then((auth) => {
                    ...
                    sheets.spreadsheets.values.get({
                        ...
                        else
                        {
                            ...
                            Bot.sendMessage("Playing powerball for " + message.name + extra + "\n" + "Powerball numbers: " + numbers1[0] + ", " + numbers1[1] + ", " + numbers1[2] + ", " + numbers1[3] + ", " + numbers1[4] + ", " + p1 + "\nYour numbers . . . . . :" + numbers2[0] + ", " + numbers2[1] + ", " + numbers2[2] + ", " + numbers2[3] + ", " + numbers2[4] + ", " + p2 + "\n " + same + " of the white balls matched, and the powerballs did " + not + " match. You have won " + points + " points. You now have " + rows[2][x] + " points. (Before: " + old + ")");
                        }
                        sheets.spreadsheets.values.update({
                            auth: auth,
                            spreadsheetId: SPREADSHEET_ID,
        ...
        googleAuth.authorize()
            .then((auth) => {
                ...
                sheets.spreadsheets.values.get({
                    ...
                    if (err) {
                        console.log('The API returned an error: ' + err);
                        Bot.sendMessage("Point entering error");
                        return;
                    }
                    var rows = response.values;
                    var x;
